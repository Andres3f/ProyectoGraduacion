...
export default function ReportsPage() {
  ...
  return (
    <div className="max-w-7xl mx-auto px-4 py-8">
      <h1 className="text-2xl font-bold text-gray-900 dark:text-gray-100 mb-1">📊 Reportes globales</h1>
      <p className="text-gray-500 dark:text-gray-400 mb-6">Todas las rutas del sistema</p>

      {/* Tarjetas resumen: total de rutas, distancia acumulada y paradas */}
      <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mb-8">
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{routes.length}</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Rutas totales</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{totalKm.toFixed(2)} km</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Distancia acumulada</p>
        </div>
        <div className="bg-white dark:bg-gray-800 rounded-2xl p-5 shadow-sm border border-gray-100 dark:border-gray-700">
          <p className="text-2xl font-bold text-gray-900 dark:text-gray-100">{totalStops}</p>
          <p className="text-sm text-gray-500 dark:text-gray-400">Paradas totales</p>
        </div>
      </div>
